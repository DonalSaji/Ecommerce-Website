...
<div class="row">
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-aqua">
                ...
                <div class="icon"> <a href="order.php">
                  <i class="ionicons ion-checkmark-circled"></i></a>
                </div>
			...
			<div class="col-lg-3 col-xs-6">
				...
				<div class="small-box bg-orange">
				  ...
				  <div class="icon"> <a href="order.php">
					<i class="ionicons ion-load-a"></i></a>
				  </div>
			  ...
			  <div class="col-lg-3 col-xs-6">
				...
				<div class="small-box bg-blue">
				  ...
				  <div class="icon"> <a href="mid-category.php">
					<i class="ionicons ion-android-menu"></i></a>
				  </div>
			  ...
			  <div class="col-lg-3 col-xs-6">
				...
				<div class="small-box bg-maroon">
				  ...
				  <div class="icon">  <a href="end-category.php">
					<i class="ionicons ion-arrow-down-b"></i></a>
				  </div>
