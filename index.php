                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            ...
                            <div class="text">
                                ...
                                <h4>
                                    &#8377 <?php echo $row['p_current_price']; ?> 
                                    <?php if($row['p_old_price'] != ''): ?>
                                    <del>
                                        &#8377 <?php echo $row['p_old_price']; ?>
                                    </del>
                                    <?php endif; ?>
                                </h4>
                                <div class="rating">
                                ...
                                <?php else: ?>
                                    <p><a href="product.php?id=<?php echo $row['p_id']; ?>"><i class="fa fa-shopping-cart"></i> <?php echo LANG_VALUE_164; ?></a></p>
                                <?php endif; ?>
                            </div>
                        </div>
                        <?php
